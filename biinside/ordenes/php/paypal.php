...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" src="https://www.paypal.com/sdk/js?client-id=AZaV4lOgvNXoTuhKiXJOt_KfSu2us1D_hGlHbY_nYJeR9XnTEnOP5OiM5NtuvsOVO6F8-xmlAHwNsAnI&disable-funding=credit,card"></script>
                ...
                onApprove: function (data, actions) {
                    ...
                    return actions.order.capture().then(function (details) {
                        ...
                        if(tipoX=='1'){
                            ...
                            $.ajax({
                                dataType: 'json',
                                url: "http://3.16.186.99/biinside/ordenes/php/actualizarPaypal.php",
                                type: "POST",
                                data: {
                                    'id': ordenX
                                },
                                success: function (data) { //Success si existe una respuesta, no importa cual porque se valida aqui mismo
                                    ...
                                    $.ajax({
                                        dataType: 'json',
                                        url: "http://3.16.186.99/biinside/ordenes/php/guardarPaypal.php",
                                        type: "POST",
                                        data: {
                                            'afiliado': afiliadoX,
                                            'cliente': clienteX,
                            ...
                            $.ajax({
                                dataType: 'json',
                                url: "http://3.16.186.99/biinside/ordenes/php/actualizarPaypalPro.php",
                                type: "POST",
                                data: {
                                    'id': ordenX
                                },
