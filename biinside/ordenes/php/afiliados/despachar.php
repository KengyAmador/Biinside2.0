<?php
	if(isset($_POST['token'])){
		...
		$message = "Su orden ha sido despachada";
		$imageUrl = isset($_POST['image_url'])?$_POST['image_url']:'';
		$action = isset($_POST['action'])?$_POST['action']:'';

		if($_POST['afiliado'] == 'BI0013'){ //IL PIACERI
			$title = "ORDEN RECIBIDA";
			$message = "Su orden ha sido recibida";
		}else if($_POST['afiliado'] == 'BI0008' || $_POST['afiliado'] == 'BI0009' || $_POST['afiliado'] == 'BI0010'){
			$title = "ORDEN DESPACHADA";
			$message = "Orden despachada y puntos acumulados";
		}
