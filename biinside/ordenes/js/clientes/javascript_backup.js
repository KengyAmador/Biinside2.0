...
function playSonido(soundObj) {
	if(afiliadCodX === 'BI0013' && sonidoSiempre != 0){
		audio.play();	
	}else{
		audio.play();
	}
...
function cargarDatosPromos(){
	var tablePr = $('#tablaPromos').DataTable({
    	...
    	"aoColumns": [
			...
			{ "mData": null,  "sDefaultContent": "<button class='btnComandaPro btn btn-sucess' style='background-color:#1c1c1ccolor:white;'>IMPRIMIR COMANDA</button>"},
