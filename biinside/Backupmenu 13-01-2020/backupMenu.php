    ...
    <div class="modal-content">
      ...
      <div class="form-group pointer">
        ...
        <div class="form-group col-md-12 text-center" id="alertAccesos">
          ...
          <hr>
          <div class="form-group text-center" id="alertAccesos">
              <div class="alert alert-info alert-dismissible fade show " id="alertRegistroAccesos" role="alert">
              <strong>Registrado!</strong> El dato se ha <strong>registrado</strong> exitosamente.
            </div>
          </div>
          <div class="form-group text-center" id="alertAccesos">
              <div class="alert alert-danger alert-dismissible fade show " id="alertEliminarAccesos" role="alert">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="form-group">
       ...
       <button class="file-upload-btn" type="button" onclick="$('.file-upload-input').trigger( 'click' )">Selecionar Imagen</button>

          <div class="image-upload-wrap">
            <input class="file-upload-input" type="file" id="inputSubirArteAccesos" name="accesoArte" onchange="readURL(this);" accept="image/*" />
            <div class="drag-text">
              <h3>Arrastre y suelte su imagen o selecione su imagen.</h3>
            </div>
          </div>
    ...
    <div class="modal-content">
      ...
      <div class="form-group">
       ...
       <button class="file-upload-btn" type="button" onclick="$('.file-upload-input').trigger( 'click' )">Selecionar Imagen</button>
          ...
          <div class="image-upload-wrap">
            <input class="file-upload-input" type="file" id="inputSubirArteProducto" name="produtoArte" onchange="readURL(this);" accept="image/*" />
            <div class="drag-text">
              <h3>Arrastre y suelte su imagen o selecione su imagen.</h3>
            </div>
          </div>
