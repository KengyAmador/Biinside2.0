		...
		<div class="col-12 col-md-12">
			<form id="frmRegistro">
				<div class="form-row">
					...
					<div class="col-12 col-md-4 mt-3">
					  <select class="form-control borde" id="puntos" name="puntos">
					  	<option value="" disabled selected>Acumulación de Puntos</option>
					  	<option value="1">Normal (Porcentajes)</option>
