...
<div id="barra-herramientas" class="toolBar">
   <div class="form-group col-xs-12"> 
	  ...
	  <div class="col-xs-8">
			<button style="margin-top: 24px" type="button" class="btn btn-primary optionsBarBTN" id="btnOtro" data-toggle="modal" onclick="otroProducto()" data-target="#exampleModal">Agregar al Inventario</button>
