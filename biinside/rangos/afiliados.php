      ...
      <div class="modal-body" style="text-align:left;">
        <form id="frmClientes">
            <div class="form-group">
              <label for="rango" class="form-control-label">Rango en metros:</label>
              <input type="number" min='1' class="form-control" id="rango" name="rango" required>
            </div>
            <div class="form-group">
              <label for="precio" class="form-control-label">Precio:</label>
              <input type="number" min='1' step=".01" class="form-control" id="precio" name="precio" required>
            </div>
          </form>
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>¿Esta seguro(a) de eliminar los rangos seleccionados?</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
