...
<?php
    ...
    try {
        ...
        $consulta = $conexion->prepare("SELECT dm.* , m.nombre as producto,mc.nombre as extra, mc.descripcion as descripcion, me.codigo as codigoextra, me.precio as precioextra FROM tbdetallemenus dm JOIN tbmenuextras me ON dm.codigo = me.detallemenu JOIN tbmenucategorias mc ON me.extra = mc.codigo JOIN tbmenus m ON dm.menu = m.codigo WHERE me.estado = 'A' AND dm.codigo = ".$codigo.";"); //Hacer la consulta
