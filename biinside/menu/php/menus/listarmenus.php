...
<?php
    ...
    try {
        ...
        $consulta = $conexion->prepare("SELECT m.codigo, m.nombre  FROM tbmenus m JOIN tbmenucategorias mc ON m.categoria = mc.codigo where m.estado = 'A' and mc.afiliado = '" .$afiliado."'"); //Hacer la consulta
