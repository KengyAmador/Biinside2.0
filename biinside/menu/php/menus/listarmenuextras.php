...
<?php
    ...
    try {
        ...
        $consulta = $conexion->prepare("SELECT m.codigo, m.nombre  FROM tbmenucategorias m  where m.estado = 'A' and  m.afiliado = '" .$afiliado."' and m.referencia = 'EXTRA'"); //Hacer la consulta
