...
<?php
    ...
    try {
        ...
        $consulta = $conexion->prepare("SELECT mc.codigo, mc.nombre  FROM tbmenucategorias mc where estado = 'A' and referencia = '" .$referencia."' and afiliado = '" .$afiliado."'"); //Hacer la consulta
